...
// Ícone em SVG para evitar dependência de bibliotecas externas.
...
function App() {
  ...
  useEffect(() => {
    ...
    // Interrompe o timer se o componente for desmontado.
  ...
  return (
    <div>
      {/* Cabeçalho semântico: ajuda usuários e mecanismos de busca a entenderem a navegação. */}
      <header className="site-header">
        <div className="container header-inner">
          ...
          {/* Botão acessível para abrir e fechar o menu mobile. */}
        ...
        {/* O menu só é renderizado quando necessário para evitar elementos duplicados. */}
        {menuOpen && (
          <nav className="mobile-menu" aria-label="Navegação mobile">
            ...
            <a href="#atendimento" onClick={() => setMenuOpen(false)}>Atendimentos</a>
      ...
      <main id="top">
        {/* Hero: a imagem é aplicada como background no CSS para ocupar toda a primeira tela. */}
          ...
          <div className="container">
            <div className="hero-content">
              ...
              <div className="hero-actions">
                ...
                {/* CTA com texto digitado e ícone do WhatsApp. */}
                <a className="whatsapp-type" href={WHATSAPP_URL} target="_blank" rel="noreferrer">
                  <WhatsAppIcon size={17} />
                  <span>{typedText}</span><span className="type-cursor" aria-hidden="true" />
                </a>

                {/* O pedido do usuário foi deixar este link abaixo do WhatsApp. */}
        ...
        <section id="sobre" className="section" aria-labelledby="sobre-title">
          <div className="container section-grid">
            <div>
              ...
              <h2 id="sobre-title">A sua história merece ser <em>ouvida.</em></h2>
            </div>
            <div className="section-copy">
              ...
              <div className="stats">
                <div className="stat"><strong>CRP 00/00000</strong><small>Psicóloga clínica</small></div>
                <div className="stat"><strong>8 anos</strong><small>de prática e estudo contínuo</small></div>
              </div>
            </div>
          </div>
        </section>

        {/* Explicação da abordagem terapêutica. */}
        <section id="abordagem" className="section section-blue" aria-labelledby="abordagem-title">
          <div className="container section-grid">
            <div>
              <SectionLabel>Como trabalhamos</SectionLabel>
              <h2 id="abordagem-title">Clareza para entender. <em>Cuidado</em> para transformar.</h2>
            </div>
            <div className="section-copy">
        ...
        {/* Atendimento único, pois a profissional atende exclusivamente online. */}
        <section id="atendimento" className="section" aria-labelledby="atendimento-title">
          <div className="container section-grid">
            <div>
              <SectionLabel>Atendimentos</SectionLabel>
              <h2 id="atendimento-title">Cuidado que cabe na sua <em>rotina.</em></h2>
            </div>
            <div className="section-copy">
              <p>Sessões exclusivamente online, com conforto, privacidade e flexibilidade para você cuidar de si onde estiver.</p>
              <article className="card" style={{ marginTop: "36px", background: "var(--blue-soft)" }}>
                <span className="card-number">◎</span><h3>Terapia online</h3>
                <p>Um espaço reservado e seguro para a sua sessão, sem deslocamento e no ritmo da sua rotina.</p>
              </article>
            </div>
          </div>
        </section>
            ...
            <div className="faq-list">
              {faqItems.map((question, index) => (
                <div className="faq-item" key={question}>
                  <button className="faq-question" type="button" aria-expanded={openFaq === index} onClick={() => setOpenFaq(openFaq === index ? null : index)}>
      ...
      <footer className="site-footer">
        <div className="container footer-inner"><strong className="logo">Clara <span>Menezes</span></strong><span>© 2024 · Psicologia clínica</span></div>
      </footer>
    </div>
  );
}
